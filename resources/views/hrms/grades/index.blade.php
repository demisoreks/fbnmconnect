...
<div class="row">
    <div class="col-12" style="margin-bottom: 20px;">
        <a class="btn btn-primary" href="{{ route('grades.create') }}"><i class="fas fa-plus"></i> New Grade</a>
    </div>
</div>
<div class="row">
    <div class="col-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a title="Edit" href="{{ route('grades.edit', [$grade->slug()]) }}"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;
                                        <a title="Trash" href="{{ route('grades.disable', [$grade->slug()]) }}" onclick="return confirmDisable()"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                    @endif
                                @endforeach
                        ...
                        <table id="myTable2" class="display-1 table table-condensed table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $grade->code }}</td>
                                    <td class="text-center">
                                        <a title="Restore" href="{{ route('grades.enable', [$grade->slug()]) }}"><i class="fas fa-undo"></i></a>
                                    </td>
                                </tr>
                                    @endif
                                @endforeach
