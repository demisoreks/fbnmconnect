...
<div class="row">
    <div class="col-12" style="margin-bottom: 20px;">
        <a class="btn btn-primary" href="{{ route('departments.create') }}"><i class="fas fa-plus"></i> New Department</a>
    </div>
</div>
<div class="row">
    <div class="col-12">
                        ...
                        <table id="myTable1" class="display-1 table table-condensed table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary btn-block btn-sm" href="{{ route('departments.units.index', [$department->slug()]) }}">Manage Units</a></td>
                                    <td class="text-center">
                                        <a title="Edit" href="{{ route('departments.edit', [$department->slug()]) }}"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;
                                        <a title="Trash" href="{{ route('departments.disable', [$department->slug()]) }}" onclick="return confirmDisable()"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                    @endif
                                @endforeach
                        ...
                        <table id="myTable2" class="display-1 table table-condensed table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary btn-block btn-sm" href="{{ route('departments.units.index', [$department->slug()]) }}">Manage Units</a></td>
                                    <td class="text-center">
                                        <a title="Restore" href="{{ route('departments.enable', [$department->slug()]) }}"><i class="fas fa-undo"></i></a>
                                    </td>
                                </tr>
                                    @endif
                                @endforeach
