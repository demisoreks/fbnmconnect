...
class LoginController extends Controller
{
    ...
    public function dashboard() {
        ...
        $cabal = Lava::DataTable();
        $cabal->addStringColumn('Category');
        $cabal->addNumberColumn('Budget');
        $cabal->addNumberColumn('Actual');
        
        $cabal->addRow(['Deposits', 50000000, 35000000]);
        $cabal->addRow(['Loans', 40000000, 22000000]);
        
        Lava::ColumnChart('Cabal', $cabal, [
            'title' => 'My Cabal',
            'fontName' => 'Poppins',
            'height' => '200',
            'width' => '100%'
